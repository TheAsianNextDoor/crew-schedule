...
export const up = async function (knex) {
  ...
  //     "estimated_mobilization_time" float,
  //     "actual_mobilization_time" float,
  //     "scheduled_date_time" timestamp,
  //     "start_date_time" timestamp,
  //     "created_at" timestamp DEFAULT (now())
  //   );
  ...
  // await knex.raw(`CREATE INDEX ON "site" ("job_number");`);
  ...
  // await knex.raw(`ALTER TABLE "crew" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");`);
  ...
  // await knex.raw(`ALTER TABLE "phase" ADD FOREIGN KEY ("site_id") REFERENCES "site" ("id");`);
  ...
  // await knex.raw(`ALTER TABLE "site" ADD FOREIGN KEY ("company") REFERENCES "company" ("id");`);

  // await knex.raw(`ALTER TABLE "site" ADD FOREIGN KEY ("client_id") REFERENCES "client" ("id");`);
