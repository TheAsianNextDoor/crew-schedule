  ...
  await prisma.site.createMany({
    data: [
      ...
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: null,
        finished_date_time: null,
      },
      {
      ...
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: new Date('2023-08-20 08:00:00'),
        finished_date_time: null,
      },
      {
        site_id: site8,
      ...
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: new Date('2023-08-20 08:00:00'),
        finished_date_time: new Date('2023-08-23 08:00:00'),
      },
      {
        site_id: site11,
        customer_id: customer1,
  ...
  await prisma.phaseAssignment.createMany({
    data: [
      ...
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: new Date('2023-07-20 08:00:00'),
        finished_date_time: null,
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: new Date('2023-09-20 08:00:00'),
        finished_date_time: null,
      },
      {
      ...
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: new Date('2023-08-20 08:00:00'),
        finished_date_time: new Date('2023-08-21 08:00:00'),
      },
      {
        ...
        scheduled_date_time: new Date('2023-07-20 08:00:00'),
        start_date_time: new Date('2023-08-20 08:00:00'),
        finished_date_time: new Date('2023-08-22 08:00:00'),
      },
      {
